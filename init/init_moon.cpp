...
void vendor_load_properties() {
    ...
    } else if (sku == "moon_r_gl") {
        model_property_override("moon", "Redmi 13x");
    } else if (sku == "tides_gl") {
        model_property_override("tides", "Redmi 13");
    } else if (sku == "tides_i_gl") {
        model_property_override("tides", "Redmi 13x");
    } else if (sku == "tides_in") {
        model_property_override("tides", "tides_in");
    } else if (sku == "tides_p_in") {
        model_property_override("tides", "tides_p_in");
    } else if (sku == "tides_r_gl") {
        model_property_override("tides", "Redmi 13x");
